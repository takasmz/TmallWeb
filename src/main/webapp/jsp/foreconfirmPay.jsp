...
<div class="confirmPayPageDiv">
	<div class="confirmPayImageDiv">
		<img src="<%=basePath%>image/comformPayFlow.png">
		<div  class="confirmPayTime1">
			<span>${client.getTime()}</span>
		</div>
	...
	<div class="confirmPayOrderItemDiv">
		...
		<table class="confirmPayOrderItemTable">
			<thead>
				...
				<tr>
					<td><img width="50px" src="<%=basePath%>${map.key.getImgpath()}"></td>
					<td class="confirmPayOrderItemProductLink">
						<a href="<c:url value="/foreproduct?pid=${map.key.getId()}"></c:url>">${map.key.getName()}</a>
					</td>
					<td>￥${map.key.getPrice()}</td>
					<td>${map.value}</td>
					<td><span class="conformPayProductPrice">￥${map.key.getPrice()*map.value}</span></td>
		...
		<div class="confirmPayOrderItemText pull-right">
			实付款： <span class="confirmPayOrderItemSumPrice">￥${client.getPayment()}</span>
		</div>
	...
	<div class="confirmPayOrderDetailDiv">
		...
		<table class="confirmPayOrderDetailTable">
			<tr>
				<td>订单编号：</td>
				<td>${client.getClient_id()} <img width="23px" src="<%=basePath%>image/confirmOrderTmall.png"></td>
			</tr>
			<tr>
				<td>卖家昵称：</td>
	...
	<div class="confirmPayButtonDiv">
		...
		<a href="<c:url value="/foreorderConfirmed?cid=${client.getId()}"></c:url>"><button class="confirmPayButton">确认支付</button></a>
	</div>
</div>
...
<div id="footer"  class="footer" style="display: block;">
    ...
    <div id="footer_ensure" class="footer_ensure">
            <a href="#nowhere">
            	<img src="<%=basePath%>image/ensure.png">
            </a>
    </div>
    ...
    <div id="copyright" class="copyright">
    	...
    	<img id="cateye" class="cateye" src="<%=basePath%>image/you.png">
