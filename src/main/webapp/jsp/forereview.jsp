...
<div class="reviewDiv">
<form method="post" action="<c:url value="/foredoreview"></c:url>">
	<c:forEach items="${productionmap}" var="map">
	<div class="reviewProductInfoDiv">
		<div class="reviewProductInfoImg">
			<img width="400px" height="400px" src="<%=basePath%>${map.key.getImgpath()}">
		</div>
		<div class="reviewProductInfoRightDiv">
			<div class="reviewProductInfoRightText">${map.key.getName()}</div>
			<div class="makeReviewDiv" style="height: 328px;">
				<div class="makeReviewText">其他买家，需要你的建议哦！</div>
				<table class="makeReviewTable">
					<tr>
						<td class="makeReviewTableFirstTD">评价商品</td>
						<td><textarea name="content${map.value.getId()}" style="width: 370px;height: 200px;"></textarea></td>
	...
	<div class="makeReviewButtonDiv">
			<input type="hidden" name="cid" value="${client.getId()}">
			<!-- <input type="hidden" name="pid" value="${order.getProduction_id() }"> -->
			<button type="submit" id="submit">提交评价</button>
	</div>
</form>
</div>
