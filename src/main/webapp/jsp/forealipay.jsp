...
<div class="aliPayPageDiv">
	<div class="aliPayPageLogo">
		<img class="pull-left" src="<%=basePath %>image/simpleLogo.png">
	...
	<div>
		...
		￥${client.getPayment()}</span>
		
	</div>
	<div>
		<img class="aliPayImg" src="<%=basePath %>image/forealipay/alipay2wei.png">
	</div>
	
	<div>
		<a href="<c:url value="/forepayed?cid=${client.getClient_id()}"></c:url>"> <button class="confirmPay">确认支付</button></a>
		
		<a href="<c:url value="/forepayexit?cid=${client.getClient_id()}"></c:url>"><button class="confirmPay">取消支付</button></a>
	</div>
